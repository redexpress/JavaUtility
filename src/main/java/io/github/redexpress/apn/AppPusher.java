package io.github.redexpress.apn;
...
public class AppPusher {
	...
	private static void pushToMyApp(String deviceToken, String certificatePath, String certificatePassword) throws Exception {
		...
		// Connect to APNs
		/************************************************
		 * Development Server Address: gateway.sandbox.push.apple.com /Port: 2195
		 * Production Server Address: gateway.push.apple.com /Port: 2195
		 ***************************************************/
